...
class AnalysisController extends Controller
{
    ...
    public function analisa(DataFuzzy $data_fuzzy)
    {
        ...
        $data_fuzzy->fuzzyfikasi()->save($fuzzyfikasi);
        ...
        $data_fuzzy->inferensi()->save($inferensi);
        ...
        $data_fuzzy->defuzzyfikasi()->save($defuzzyfikasi);

        return view('analisa_fuzzy.hasil', compact('data_fuzzy', 'fuzzyfikasi', 'inferensi', 'defuzzyfikasi'));
    }

    public function list(DataFuzzy $data_fuzzy)
    {
        $data_fuzzies = DataFuzzy::all();
        return view('analisa_fuzzy.list', compact('data_fuzzies'));
    }
